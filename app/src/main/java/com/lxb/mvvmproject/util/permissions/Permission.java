package com.lxb.mvvmproject.util.permissions;
...
public final class Permission {
    ...
    public static final String USE_FINGERPRINT = "android.permission.USE_FINGERPRINT"; // 指纹
    ...
    public static final class Group {
        ...
        //电话
        public static final String[] PHONE_GROUP = {Permission.READ_PHONE_STATE, Permission.CALL_PHONE,
        ...
        public static final String[] SMS_GROUP = {
                ...
                Permission.READ_SMS, Permission.RECEIVE_WAP_PUSH,
